...
st.subheader('**Copy Rights**')
def main():

    #  copyright notice
    st.write("© 2023 Abdul Moeez. All rights reserved.")
    # Github Profile 
    st.markdown("[GitHub Profile](https://github.com/mianabdulmoez)")
    # Linkedin Profile
    st.markdown("[LinkedIn Profile](https://www.linkedin.com/in/abdul-moez-91a196222/)") 
